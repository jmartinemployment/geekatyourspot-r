...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/services/process-automation" },
};

const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": "https://www.geekatyourspot.com/services/process-automation#service",
  name: service.name,
  description: service.metaDescription,
  serviceType: service.serviceType,
  provider: { "@id": "https://www.geekatyourspot.com/#business" },
  areaServed: "South Florida",
  url: "https://www.geekatyourspot.com/services/process-automation",
};

export default function ProcessAutomationPage(): React.JSX.Element {
  return (
    <>
