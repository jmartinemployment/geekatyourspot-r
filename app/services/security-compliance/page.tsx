...
const service = services.find((s) => s.slug === "security-compliance")!;

export const metadata: Metadata = {
  title: service.metaTitle,
  description: service.metaDescription,
  alternates: { canonical: "/services/security-compliance" },
};

const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": "https://www.geekatyourspot.com/services/security-compliance#service",
  name: service.name,
  description: service.metaDescription,
  serviceType: service.serviceType,
  provider: { "@id": "https://www.geekatyourspot.com/#business" },
  areaServed: "South Florida",
  url: "https://www.geekatyourspot.com/services/security-compliance",
};

export default function SecurityCompliancePage(): React.JSX.Element {
  return (
    <>
