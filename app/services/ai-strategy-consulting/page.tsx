...
const service = services.find((s) => s.slug === "ai-strategy-consulting")!;

export const metadata: Metadata = {
  title: service.metaTitle,
  description: service.metaDescription,
  alternates: { canonical: "/services/ai-strategy-consulting" },
};

const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": "https://www.geekatyourspot.com/services/ai-strategy-consulting#service",
  name: service.name,
  description: service.metaDescription,
  serviceType: service.serviceType,
  provider: { "@id": "https://www.geekatyourspot.com/#business" },
  areaServed: "South Florida",
  url: "https://www.geekatyourspot.com/services/ai-strategy-consulting",
};

export default function AiStrategyConsultingPage(): React.JSX.Element {
  return (
    <>
