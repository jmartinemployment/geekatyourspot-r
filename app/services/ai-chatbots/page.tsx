...
const service = services.find((s) => s.slug === "ai-chatbots")!;

export const metadata: Metadata = {
  title: service.metaTitle,
  description: service.metaDescription,
  alternates: { canonical: "/services/ai-chatbots" },
};

const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": "https://www.geekatyourspot.com/services/ai-chatbots#service",
  name: service.name,
  description: service.metaDescription,
  serviceType: service.serviceType,
  provider: { "@id": "https://www.geekatyourspot.com/#business" },
  areaServed: "South Florida",
  url: "https://www.geekatyourspot.com/services/ai-chatbots",
};

export default function AiChatbotsPage(): React.JSX.Element {
  return (
    <>
