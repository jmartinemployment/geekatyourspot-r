...
const service = services.find((s) => s.slug === "ai-content-marketing")!;

export const metadata: Metadata = {
  title: service.metaTitle,
  description: service.metaDescription,
  alternates: { canonical: "/services/ai-content-marketing" },
};

const schema = {
  "@context": "https://schema.org",
  "@type": "Service",
  "@id": "https://www.geekatyourspot.com/services/ai-content-marketing#service",
  name: service.name,
  description: service.metaDescription,
  serviceType: service.serviceType,
  provider: { "@id": "https://www.geekatyourspot.com/#business" },
  areaServed: "South Florida",
  url: "https://www.geekatyourspot.com/services/ai-content-marketing",
};

export default function AiContentMarketingPage(): React.JSX.Element {
  return (
    <>
