        ...
        <div className="grid grid-cols-2 content-center gap-4 items-center min-h-screen container">
          ...
          <div className="flex items-center justify-center min-h-screen">
            <Image
              ...
              height={562}
              quality={100}
              alt="Geek At Your Spot - AI created figure of me, representing my hands-on, personalized approach to sharing knowledge and helping small businesses succeed with technology."
