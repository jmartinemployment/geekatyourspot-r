...
const departments = [
  { id: "operations", label: "Operations", content: "Streamline workflows by automating repetitive tasks like data entry, invoicing, and document management. Optimize supply chains, predict issues before they happen, and keep your business running efficiently." },
  { id: "sales", label: "Sales", content: "Substantial sales content..." },
  { id: "marketing", label: "Marketing", content: "Generate content in seconds, personalize customer experiences, and identify high-quality leads. Use AI to optimize pricing, improve conversions, and accelerate revenue growth." },
  { id: "accounting", label: "Accounting", content: "Automate reporting, detect fraud, and improve financial accuracy with AI-driven insights that keep your business compliant and efficient." },
  { id: "hr", label: "Human Resources", content: "Substantial sales content..." },
  { id: "customer", label: "Customer Service", content: "Provide instant, 24/7 support with AI-powered chat systems. Analyze customer sentiment in real time and resolve issues faster while reducing support workload." },

];

export default function UseCaseCaseStudySection() {
  return (
    <>
    <section className="w-full bg-[#0A080D] min-h-screen lg:hidden">
    ...
    <section className="w-full bg-[#0A080D] hidden lg:block min-h-screen">
